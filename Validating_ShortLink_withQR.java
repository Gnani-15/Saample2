...
public class Validating_ShortLink_withQR {
	...
	public void launchBrowser() throws InterruptedException 
	   {
		 ...
		 D_Url.sendKeys("https://www.selenium.dev/projects/");
		 
		 
		 //Enter Slash tag
		 WebElement slash_tag = driver.findElement(By.xpath("//input[@placeholder='Generated Slash Tag']"));
		 slash_tag.sendKeys("Projects");
		 
		 //Generate QR Code
		
		 WebElement QRCode = driver.findElement(By.xpath("//label[@class='d-flex flex-stack mb-5 w-100 border border-dotted border-info cursor-pointer rounded-1 p-5 min-h-95px form-label']/child::span[2]/child::input"));
		 QRCode.click();
